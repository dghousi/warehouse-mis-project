...
const AlertDialog = ({
  ...props
}: Readonly<React.ComponentProps<typeof AlertDialogPrimitive.Root>>): JSX.Element => {
...
const AlertDialogPortal = ({
  ...props
}: Readonly<React.ComponentProps<typeof AlertDialogPrimitive.Portal>>): JSX.Element => {
