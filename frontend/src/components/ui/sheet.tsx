...
const Sheet = ({
  ...props
}: Readonly<React.ComponentProps<typeof SheetPrimitive.Root>>): JSX.Element => {
...
const SheetPortal = ({
  ...props
}: Readonly<React.ComponentProps<typeof SheetPrimitive.Portal>>): JSX.Element => {
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'top' &&
            'data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top inset-s-0 inset-e-0 top-0 h-auto border-b',
          side === 'bottom' &&
            'data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-s-0 inset-e-0 bottom-0 h-auto border-t',
          className
        )}
        {...props}
      >
